...
public class BluetoothLeService extends Service {
    ...
    public final static String ACTION_GATT_CONNECTED =
            "com.oymotion.bluetooth.le.ACTION_GATT_CONNECTED";
    public final static String ACTION_GATT_DISCONNECTED =
            "com.oymotion.bluetooth.le.ACTION_GATT_DISCONNECTED";
    public final static String ACTION_GATT_SERVICES_DISCOVERED =
            "com.oymotion.bluetooth.le.ACTION_GATT_SERVICES_DISCOVERED";
    public final static String ACTION_DATA_AVAILABLE =
            "com.oymotion.bluetooth.le.ACTION_DATA_AVAILABLE";
    public final static String EXTRA_DATA =
            "com.oymotion.bluetooth.le.EXTRA_DATA";

    public static class GForceDataType {
        public static final byte QUATERNION_FLOAT      = 0x2;
        public static final byte GESTURE               = 0xF;
    }
    ...
    private void broadcastUpdate(final String action,
        ...
        if (Characteristic.HEART_RATE_MEASUREMENT.equals(characteristicUuid)) {
            HeartRateMeasurement hrm = new HeartRateMeasurement(data);
